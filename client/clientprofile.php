            ...
            <ul class="nav navbar-right top-nav">
                                ...
                                <div class="media">
                                    <span class="pull-left">
                                        <img class="media-object"
                                            src="http://www.readingfc.co.uk/images/common/bg_player_profile_default_big.png"
                                            alt="">
                                    </span>
                                    <div class="media-body">
                                        <h5 class="media-heading">
                                            <strong><?php echo $userRow['userFirstName']; ?>
                                                <?php echo $userRow['userLastName']; ?></strong>
                                        </h5>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="clientupdateprofile.php?patientId=<?php echo $userRow['idUser']; ?>"><i
                                    class="fa fa-fw fa-user"></i> Update Profile</a>
                        </li>
                        <li>
                        ...
                        <div
                            ...
                            <div class="panel panel-info">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo $userRow['userFirstName']; ?>
                                        <?php echo $userRow['userLastName']; ?></h3>
                                </div>
                                        ...
                                        <form action="<?php echo $editFormAction; ?>" method="post" name="form1"
                                            ...
                                            <div class=" col-md-9 col-lg-9 ">
                                                ...
                                                <input type="hidden" name="patientId"
                                                    value="<?php echo $userRow['patientId']; ?>" />
