                        ...
                        <div
                            ...
                            <div class="panel panel-info">
                                <div class="panel-heading">
                                    <h2 class="panel-title"><?php echo $userRow['userFirstName']; ?>
                                        <?php echo $userRow['userLastName']; ?></h2>
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-3 col-lg-3 " align="center"> <img alt="User Pic"
                                                src="http://placehold.it/250x250" class="img-circle img-responsive">
                                        </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="form-control"
                                                                    name="userFirstName"
                                                                    value="<?php echo $userRow['userFirstName']; ?>" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>userLastName</td>
                                                            <td><input type="text" class="form-control"
                                                                    name="userLastName"
                                                                    value="<?php echo $userRow['userLastName']; ?>" />
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td>
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input class="form-control" id="userDOB"
                                                                            name="userDOB" placeholder="MM/DD/YYYY"
                                                                            type="text"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="form-control"
                                                                    name="userAddress"
                                                                    value="<?php echo $userRow['userAddress']; ?>" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>userPhone</td>
