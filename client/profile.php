                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i>
                            <?php echo $userRow['userFirstName']; ?> <?php echo $userRow['userLastName']; ?><b
                                class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href="profile.php?patientId=<?php echo $userRow['idUser']; ?>"><i
                                        class="fa fa-fw fa-user"></i> Profile</a>
                            </li>
                            <li>
                                <a href="clientapplist.php?patientId=<?php echo $userRow['idUser']; ?>"><i
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="post">
                                        <table class="table table-user-information">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>First Name:</td>
                                                    <td><input type="text" class="form-control" name="userFirstName"
                                                            value="<?php echo $userRow['userFirstName']; ?>" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Last Name</td>
                                                    <td><input type="text" class="form-control" name="userLastName"
                                                            value="<?php echo $userRow['userLastName']; ?>" /></td>
                                                </tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control" id="userDOB" name="userDOB"
                                                                    placeholder="MM/DD/YYYY" type="text"
                                                                    value="<?php echo $userRow['userDOB']; ?>" />
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="radio">
                                                            <label><input type="radio" name="userGender" value="male"
                                                                    <?php echo $male; ?>>Male</label>
                                                        </div>
                                                        <div class="radio">
                                                            <label><input type="radio" name="userGender" value="female"
                                                                    <?php echo $female; ?>>Female</label>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <!-- radio button end -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="form-control" name="userPhone"
                                                            value="<?php echo $userRow['userPhone']; ?>" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Email</td>
                                                    <td><input type="text" class="form-control" name="userEmail"
                                                            value="<?php echo $userRow['userEmail']; ?>" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Address</td>
                                                    <td><textarea class="form-control"
                                                            name="userAddress"><?php echo $userRow['userAddress']; ?></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
